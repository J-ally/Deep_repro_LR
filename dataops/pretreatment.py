...
def fetch_mnist_from_openml():
    ...
    urlretrieve(url='https://www.openml.org/data/download/18238735/phpnBqZGZ',
...
def preprocess_mnist_data():
    ...
    print(f"X_train: {mnist_28_28['X_train'].shape}, y_train: {mnist_28_28['y_train'].shape}")
    print(f"X_val: {mnist_28_28['X_val'].shape}, y_val: {mnist_28_28['y_val'].shape}")
    print(f"X_test: {mnist_28_28['X_test'].shape}, y_test: {mnist_28_28['y_test'].shape}")
